...
export function renderLandingPage(container) {
    container.innerHTML = `
        <div class="landing-wrapper">
                    ...
                    <div class="two-col" style="align-items: center; gap: 60px;">
                        <div>
                            ...
                            <p style="font-size: 18px; color: var(--text-muted); margin-bottom: 24px;">
                                Studies show that <span style="color: var(--text); font-weight: bold;">only 8% of people</span> achieve their goals. The problem isn't setting the goal—it's the gap between the <span style="font-style: italic;">intention</span> and the <span style="font-style: italic;">action</span>.
                            </p>
                            <p style="font-size: 18px; color: var(--text-muted); margin-bottom: 24px;">
                    ...
                    <div class="stats-grid" style="grid-template-columns: repeat(3, 1fr); gap: 32px; text-align: left;">
                        ...
                        <div style="position: relative;">
                            ...
                            <div style="position: relative; z-index: 1;">
                                ...
                                <p style="color: var(--text-muted); font-size: 15px; line-height: 1.6;">Use the "Implementation Intention" format: When X happens, I will do Y. This explicitly links your environment to the action.</p>
                            </div>
                        </div>
                        <!-- Step 2 -->
                        <div style="position: relative;">
                ...
                <div class="landing-content slide-up" style="max-width: 800px; margin: 0 auto; text-align: center; position: relative; z-index: 10;">
                    ...
                    <div style="margin-top: 40px; display: flex; justify-content: center; gap: 24px; font-size: 14px; color: var(--text-muted);">
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <span style="color: var(--success);">✓</span> Free forever
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <span style="color: var(--success);">✓</span> No credit card
                        </div>
                        <div style="display: flex; align-items: center; gap: 8px;">
                            <span style="color: var(--success);">✓</span> Instant setup
                        </div>
                    </div>
                </div>
            </div>
            ...
            <footer style="padding: 32px 24px; text-align: center; border-top: 1px solid var(--border); background: var(--bg-card); position: relative; z-index: 10;">
                ...
                <p style="font-size: 13px; color: var(--text-dim);">© ${new Date().getFullYear()} Gapp. Bridge the Commitment–Execution Gap.</p>
            </footer>
        </div>
    `;
    ...
    document.getElementById('bottom-get-started-btn').addEventListener('click', () => {
        navigate('/auth');
    });
}
